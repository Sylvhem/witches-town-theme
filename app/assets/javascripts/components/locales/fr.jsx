const fr = {
  ...
  "account.follows_you": "Vous a rejoint",
  "account.mention": "Jeter un sort",
  ...
  "compose_form.placeholder": "Quel sort souhaitez-vous lancer ?",
  ...
  "home.column_settings.show_reblogs": "Afficher les malédictions canalisées",
  ...
  "notifications.column_settings.follow": "Nouveaux membres :",
  "notifications.column_settings.mention": "Sorts reçus :",
  "notifications.column_settings.reblog": "Malédictions canalisées :",
  ...
  "search.status_by": "Malédictions de {name}",
  "status.delete": "Effacer",
  "status.favourite": "Placer un sigil",
  "status.load_more": "Charger plus",
  "status.media_hidden": "Média caché",
  "status.mention": "Jeter un sort",
  "status.open": "Afficher cette malédiction",
  "status.reblog": "Canaliser",
  "status.reblogged_by": "{name} a canalisé :",
  ...
  "tabs_bar.federated_timeline": "La Boule de Cristal",
  "tabs_bar.home": "Le Chaudron",
  "tabs_bar.local_timeline": "Le Sabbat",
  "tabs_bar.mentions": "Sorts reçus",
