      ...
      <div style={{ padding: '10px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
          ...
          <div style={{ display: 'flex', minWidth: 0 }}>
            <div style={{ paddingTop: '10px', marginRight: '16px', lineHeight: '36px' }}><CharacterCounter max={666} text={text} /></div>
            <div style={{ paddingTop: '10px', overflow: 'hidden' }}><Button text={publishText} onClick={this.handleSubmit} disabled={disabled || text.replace(/[\uD800-\uDBFF][\uDC00-\uDFFF]/g, "_").length > 666} block /></div>
          </div>
        </div>
      </div>
    );
